...
function Table(props) {
  ...
  const stateSortColumn = typeof window !== `undefined` ? localStorage.getItem('state.sortColumn') : '';
  const stateIsAscending = typeof window !== `undefined` ? localStorage.getItem('state.isAscending') : '';
        ...
        <thead>
          <tr>
            ...
            <th className="sticky" onClick={(e) => handleSort(e, props)}>
              <div className="heading-content">
                <abbr
                  className={`${windowInnerWidth <= 769 ? 'is-cherry' : ''}`}
                  title="Confirmed"
                >
            ...
            <th className="sticky" onClick={(e) => handleSort(e, props)}>
              <div className="heading-content">
                <abbr
                  className={`${windowInnerWidth <= 769 ? 'is-blue' : ''}`}
                  title="Active"
                >
                  {windowInnerWidth <= 769
                    ? windowInnerWidth <= 375
            ...
            <th className="sticky" onClick={(e) => handleSort(e, props)}>
              <div className="heading-content">
                <abbr
                  className={`${windowInnerWidth <= 769 ? 'is-green' : ''}`}
                  title="Recovered"
                >
                  {windowInnerWidth <= 769
                    ? windowInnerWidth <= 375
            ...
            <th className="sticky" onClick={(e) => handleSort(e, props)}>
              <div className="heading-content">
                <abbr
                  className={`${windowInnerWidth <= 769 ? 'is-gray' : ''}`}
                  title="Deaths"
                >
                  {windowInnerWidth <= 769
                    ? windowInnerWidth <= 375
